...
public typealias AssetIconsTypeAlias = IconAsset.Image
...
public enum CustomIcons {
  public static let arrowDown = IconAsset(name: "arrowDown")
  public static let arrowLeft = IconAsset(name: "arrowLeft")
  ...
  public static let allImages: [IconAsset] = [
    arrowDown,
    arrowLeft,
    arrowRight,
    block,
